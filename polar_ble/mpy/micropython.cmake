# MicroPython user C module integration for the "polar" module.
#
...
#   -DPOLAR_BLE_AUTO_APPLY_PATCHES=ON|OFF (default OFF)
...
option(POLAR_BLE_AUTO_APPLY_PATCHES "Auto-apply local MicroPython patch series during configure (mutates vendors/micropython)" OFF)
...
if(POLAR_BLE_AUTO_APPLY_PATCHES)
    if(NOT EXISTS "${POLAR_PATCH_APPLY_SCRIPT}")
        message(FATAL_ERROR
            "POLAR_BLE_AUTO_APPLY_PATCHES=ON but patch apply script was not found: ${POLAR_PATCH_APPLY_SCRIPT}")
    endif()

    message(STATUS "[polar] POLAR_BLE_AUTO_APPLY_PATCHES=ON -> applying local MicroPython patch series")
    execute_process(
        ...
        if(_polar_patch_files STREQUAL "")
            ...
            if(_polar_missing_patch_subjects)
                ...
                message(FATAL_ERROR
                    ...
                    "  -DPOLAR_BLE_AUTO_APPLY_PATCHES=ON\n\n"
...
target_sources(usermod_polar INTERFACE
    ${CMAKE_CURRENT_LIST_DIR}/mod_polar_ble.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_common.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_connect.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_transport.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_wait.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_runtime.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_runtime_context.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_transport_adapter.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_btstack_link.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_btstack_gatt.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_btstack_gatt_route.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_btstack_helpers.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_btstack_scan.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_btstack_adv_runtime.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_btstack_sm.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_sm_control.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_btstack_dispatch.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_discovery.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_discovery_orchestrator.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_discovery_dispatch.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_discovery_runtime.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_discovery_btstack_runtime.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_discovery_apply.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_gatt_control.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_gatt_notify_runtime.c
    ${CMAKE_CURRENT_LIST_DIR}/../driver/src/polar_ble_driver_gatt_query_complete.c
...
target_link_libraries(usermod INTERFACE usermod_polar)
