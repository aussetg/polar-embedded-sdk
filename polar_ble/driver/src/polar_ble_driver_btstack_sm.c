...
bool polar_ble_driver_btstack_decode_sm_event(
    ...
    out_event->type = POLAR_BLE_DRIVER_SM_EVENT_NONE;
    out_event->handle = 0;
    out_event->status = 0;
    out_event->reason = 0;
