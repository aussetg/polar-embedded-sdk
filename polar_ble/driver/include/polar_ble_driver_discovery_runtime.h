...
#ifndef POLAR_BLE_DRIVER_DISCOVERY_RUNTIME_H
#define POLAR_BLE_DRIVER_DISCOVERY_RUNTIME_H
...
typedef struct {
    void *ctx;
    void (*set_stage)(void *ctx, polar_ble_driver_discovery_stage_t stage);
...
} polar_ble_driver_discovery_runtime_ops_t;
...
#endif // POLAR_BLE_DRIVER_DISCOVERY_RUNTIME_H
