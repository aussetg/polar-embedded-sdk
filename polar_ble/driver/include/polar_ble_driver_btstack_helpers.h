...
#ifndef POLAR_BLE_DRIVER_BTSTACK_HELPERS_H
#define POLAR_BLE_DRIVER_BTSTACK_HELPERS_H
...
typedef enum {
    POLAR_BLE_DRIVER_DISC_SERVICE_NONE = 0,
    POLAR_BLE_DRIVER_DISC_SERVICE_HR,
    POLAR_BLE_DRIVER_DISC_SERVICE_PMD,
    POLAR_BLE_DRIVER_DISC_SERVICE_PSFTP,
} polar_ble_driver_disc_service_kind_t;

typedef enum {
    POLAR_BLE_DRIVER_DISC_CHAR_NONE = 0,
    POLAR_BLE_DRIVER_DISC_CHAR_HR_MEAS,
    POLAR_BLE_DRIVER_DISC_CHAR_PMD_CP,
    POLAR_BLE_DRIVER_DISC_CHAR_PMD_DATA,
    POLAR_BLE_DRIVER_DISC_CHAR_PSFTP_MTU,
    POLAR_BLE_DRIVER_DISC_CHAR_PSFTP_D2H,
    POLAR_BLE_DRIVER_DISC_CHAR_PSFTP_H2D,
} polar_ble_driver_disc_char_kind_t;
...
#endif // POLAR_BLE_DRIVER_BTSTACK_HELPERS_H
