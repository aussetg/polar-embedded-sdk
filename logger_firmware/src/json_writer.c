...
static bool logger_json_writer_append_char(logger_json_object_writer_t *writer,
                                           char ch) {
...
static bool logger_json_writer_append_text(logger_json_object_writer_t *writer,
                                           const char *text) {
  if (writer == NULL || !writer->ok || writer->closed) {
    return false;
  }
...
static bool logger_json_writer_append_hex4(logger_json_object_writer_t *writer,
                                           uint8_t value) {
  char escaped[7];
...
static bool
logger_json_writer_append_quoted_string(logger_json_object_writer_t *writer,
                                        const char *value) {
...
static bool
logger_json_object_writer_begin_field(logger_json_object_writer_t *writer,
                                      const char *key) {
  if (writer == NULL || !writer->ok || writer->closed || key == NULL ||
      key[0] == '\0') {
    if (writer != NULL) {
      writer->ok = false;
    }
...
static bool
logger_json_object_writer_unsigned_field(logger_json_object_writer_t *writer,
                                         const char *key,
...
static bool
logger_json_object_writer_signed_field(logger_json_object_writer_t *writer,
...
bool logger_json_object_writer_string_field(logger_json_object_writer_t *writer,
  ...
  return logger_json_writer_append_quoted_string(writer,
                                                 value != NULL ? value : "");
}
