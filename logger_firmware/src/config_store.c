...
#define LOGGER_FLASH_SLOT_COUNT 2u
#define LOGGER_FLASH_SLOT_SIZE FLASH_SECTOR_SIZE
...
#define LOGGER_FLASH_CONFIG_SLOT0_OFFSET LOGGER_FLASH_PERSIST_REGION_OFFSET
#define LOGGER_FLASH_CONFIG_SLOT1_OFFSET (LOGGER_FLASH_CONFIG_SLOT0_OFFSET + LOGGER_FLASH_SLOT_SIZE)
