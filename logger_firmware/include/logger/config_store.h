...
#define LOGGER_CONFIG_UPLOAD_TLS_ANCHOR_BASE64_MAX                             \
  ((((LOGGER_CONFIG_UPLOAD_TLS_ANCHOR_DER_MAX) + 2u) / 3u) * 4u)
...
typedef struct {
  ...
  char upload_tls_anchor_sha256[LOGGER_CONFIG_UPLOAD_TLS_ANCHOR_SHA256_HEX_LEN +
                                1u];
...
bool logger_config_set_bound_h10_address(logger_persisted_state_t *state,
                                         const char *value, bool *bond_cleared);
