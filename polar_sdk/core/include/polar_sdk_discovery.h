...
#ifndef POLAR_SDK_DISCOVERY_H
#define POLAR_SDK_DISCOVERY_H
...
typedef enum {
  POLAR_SDK_DISC_STAGE_IDLE = 0,
  POLAR_SDK_DISC_STAGE_SERVICES,
  POLAR_SDK_DISC_STAGE_HR_CHARS,
  POLAR_SDK_DISC_STAGE_PMD_CHARS,
  POLAR_SDK_DISC_STAGE_PSFTP_CHARS,
} polar_sdk_discovery_stage_t;

typedef enum {
  POLAR_SDK_DISC_ACTION_FAIL = 0,
  POLAR_SDK_DISC_ACTION_DISCOVER_HR_CHARS,
  POLAR_SDK_DISC_ACTION_DISCOVER_PMD_CHARS,
  POLAR_SDK_DISC_ACTION_DISCOVER_PSFTP_CHARS,
  POLAR_SDK_DISC_ACTION_READY,
} polar_sdk_discovery_action_t;
