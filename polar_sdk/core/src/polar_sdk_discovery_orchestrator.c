...
polar_sdk_discovery_step_t polar_sdk_discovery_on_query_complete(
  ...
  polar_sdk_discovery_action_t action = polar_sdk_discovery_next_action(
      snapshot->stage, snapshot->required_services_mask,
      snapshot->hr_service_found, snapshot->pmd_service_found,
      snapshot->psftp_service_found, snapshot->hr_measurement_handle,
      snapshot->pmd_cp_handle, snapshot->pmd_data_handle,
      snapshot->psftp_mtu_handle, snapshot->psftp_d2h_handle,
      snapshot->psftp_h2d_handle, service_hr_bit, service_ecg_bit,
      service_psftp_bit, &next_stage);
