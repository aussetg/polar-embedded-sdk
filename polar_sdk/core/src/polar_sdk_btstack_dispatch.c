...
bool polar_sdk_btstack_dispatch_event(
    ...
    polar_sdk_btstack_adv_report_t adv_report;
    if (polar_sdk_btstack_decode_adv_report(packet_type, packet, &adv_report)) {
    ...
    polar_sdk_link_event_t link_event;
    if (polar_sdk_btstack_decode_link_event(packet_type, packet, &link_event)) {
