...
static uint32_t polar_sdk_connect_elapsed_ms(uint32_t start_ms, uint32_t now_ms) {
...
bool polar_sdk_connect_has_time_left(
    ...
    return polar_sdk_connect_elapsed_ms(state->start_ms, now_ms) < policy->timeout_ms;
}
